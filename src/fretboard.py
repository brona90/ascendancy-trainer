...
# Open string pitches in semitones from C — DROP D tuning (D2 A2 D3 G3 B3 E4).
# The whole site lives in drop D, so string 6 is a D, not an E.
# We just need pitch class, not octave.
OPEN_STRING_PC = {6: 2, 5: 9, 4: 2, 3: 7, 2: 11, 1: 4}
