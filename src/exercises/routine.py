...
EXERCISE = {
    ...
    "intro_prose": """
      <p>A song this fast is a physical adaptation as much as a mental one
      — and adaptations come from <em>daily</em> exposure, not weekend
      marathons. This lap touches every skill the song demands in thirty
      minutes. Run it once a day; the back ten minutes are where the actual
      song gets assembled, one chunk at a time.</p>
      <p>One tempo discipline rules the session: pick your ladder rung
      (the metronome remembers it across every page), earn it clean, and
      only raise it tomorrow.</p>
    """,
    "intro_pills": [
        ("Tempo discipline", "One bpm per session. Clean three times in a row = +5 next session."),
    ...
    "sections": [
        {
            ...
            "cards": [
                {
                    "num": "0:00 → 2:00", "title": "Tune and check",
                    "role": "2 min · drop D, octave + unison checks",
                    "body": _body(
                        '<p>' + _link('./tuning.html', 'Drop D page') + ': run both tuning '
                        'checks. Then thirty seconds of slow one-finger power-chord slides, '
                        'eyes closed, listening for buzz.</p>'
                        '<p style="margin:0;"><strong>Goal:</strong> perfect octave, relaxed grip.</p>'),
                    "caption": "Drop-tuned strings drift. Never skip the check.",
                },
                {
                    ...
                    "body": _body(
                        ...
                        '<p style="margin:0;"><strong>Rule:</strong> one flam = restart the minute.</p>'),
                ...
                },
                {
                    ...
                    "body": _body(
                        '<p>' + _link('./dminor.html', 'D minor map') + ': one box per day. '
                ...
                },
                {
                    ...
                    "role": "4 min · alternate harmony and lead days",
                    "body": _body(
                        '<p>Odd days: ' + _link('./harmony.html', 'Harmonized thirds') + ' — '
                        'play one voice live against the other voice\'s looped audio.</p>'
                        '<p>Even days: ' + _link('./leads.html', 'Lead toolkit') + ' — one '
